...
import uk.ac.york.cs.statemachines.util.StatemachinesValidator;
...
public class StatemachinesPackageImpl extends EPackageImpl implements StatemachinesPackage {
	 ...
	 * @see uk.ac.york.cs.statemachines.StatemachinesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		createEReference(stateMachineEClass, STATE_MACHINE__RESET_EVENTS);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (stateEClass, 
		   source, 
		   new String[] {
			 "noSelfTransition", "transitions.state->excludes(self)"
		   });
	}
