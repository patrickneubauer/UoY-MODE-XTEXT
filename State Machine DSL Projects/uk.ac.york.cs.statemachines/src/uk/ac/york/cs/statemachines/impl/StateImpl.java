 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.cs.statemachines.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.york.cs.statemachines.impl.StateImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, StatemachinesPackage.STATE__TRANSITIONS);
		}
		return transitions;
	}
