...
public class StatemachinesValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "uk.ac.york.cs.statemachines";
	...
	public boolean validateState(State state, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateState_noSelfTransition(state, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the noSelfTransition constraint of '<em>State</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String STATE__NO_SELF_TRANSITION__EEXPRESSION = "transitions.state->excludes(self)";

	/**
	 * Validates the noSelfTransition constraint of '<em>State</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateState_noSelfTransition(State state, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(StatemachinesPackage.Literals.STATE,
				 ...
				 "noSelfTransition",
				 STATE__NO_SELF_TRANSITION__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
