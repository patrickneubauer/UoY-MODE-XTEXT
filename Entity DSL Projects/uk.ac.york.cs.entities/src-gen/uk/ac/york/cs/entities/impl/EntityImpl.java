 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.cs.entities.impl.EntityImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link uk.ac.york.cs.entities.impl.EntityImpl#getExtends <em>Extends</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends TypeImpl implements Entity {
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class, this,
					EntitiesPackage.ENTITY__PROPERTIES);
		}
		return properties;
	}
		...
		if (extends_ != null && extends_.eIsProxy()) {
			...
			if (extends_ != oldExtends) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntitiesPackage.ENTITY__EXTENDS,
							oldExtends, extends_));
			}
		}
		return extends_;
	...
	public void setExtends(Entity newExtends) {
		...
		extends_ = newExtends;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitiesPackage.ENTITY__EXTENDS, oldExtends,
					extends_));
	}
